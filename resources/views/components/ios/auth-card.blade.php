...
<body class="antialiased">
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br {{ $gradient }}">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-0 -left-4 w-96 h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
        <div class="absolute top-0 -right-4 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
    ...
    <div class="relative sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div class="flex justify-center mb-8 animate-fade-in-up">
            <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-4 shadow-2xl border border-white/20">
    ...
    <div class="relative mt-8 sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up animation-delay-400">
        <div class="bg-white/95 backdrop-blur-xl py-10 px-6 shadow-2xl rounded-3xl border border-white/50 sm:px-12">
            {{ $slot }}
        </div>
        ...
        <div class="mt-6 text-center animate-fade-in-up animation-delay-600">
            <div class="bg-white/10 backdrop-blur-xl rounded-2xl py-4 px-6 border border-white/20">
                {{ $footer }}
            </div>
        </div>
        @endif
